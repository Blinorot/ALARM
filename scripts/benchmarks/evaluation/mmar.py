...
def get_results(input_data):
    ...
    modality_metrics = {
        ...
        "speech": [0, 0],
        "mix-sound-music": [0, 0],
        "mix-sound-speech": [0, 0],
        "mix-music-speech": [0, 0],
        "mix-sound-music-speech": [0, 0],
    }
    category_metrics = {
        "Signal Layer": [0, 0],
        "Perception Layer": [0, 0],
        "Semantic Layer": [0, 0],
        "Cultural Layer": [0, 0],
    }
    ...
    total_acc = (corr / total) * 100
    modality_acc = {}
    for modality in modality_metrics:
        n_correct, n_total = modality_metrics[modality]
        acc = (n_correct / n_total) * 100 if n_total > 0 else 0
        modality_acc[modality] = acc

    return modality_acc, total_acc
